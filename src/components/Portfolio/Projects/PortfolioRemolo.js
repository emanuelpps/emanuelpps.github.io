  ...
  return (
    <div ref={ref} className="portfolio-box">
      ...
      <div className="button-box-portfolio">
        <Link
          to={"https://github.com/emanuelpps/don-remolo-pizza"}
          target="_blank"
        >
          <button
            title="Code"
      ...
      <motion.section className="description-box" animate={animation}>
        ...
        <p className="text-box">
          ...
          functionalities. It is highly responsive across various devices thanks
          to Bootstrap. Real-time user experience is facilitated through React
          JS and Firebase. Ordering food has never been easier and more
          convenient.
        </p>
        <ul>
          <li>CSS3</li>
